...
(function () {
    ...
    function Calculator() {
        ...
        this.chart = {
            ...
            label: 'year3',
            labels: {
                year1: ["0", "2 months", "4 months", "6 months", "8 months", "10 months", "12 months"],
                year2: ["0", "4 months", "8 months", "12 months", "16 months", "20 months", "24 months"],
                year3: ["0", "6 months", "12 months", "18 months", "24 months", "30 months", "36 months"],
                year4: ["0", "8 months", "16 months", "24 months", "32 months", "40 months", "48 months"],
                year5: ["0", "10 months", "20 months", "30 months", "40 months", "50 months", "60 months"]
            },
            compoundInterest:{
                object: ''
            },
    ...
    Calculator.prototype.updateOutputs = function (keyMain) {
        ...
        var currentPeriod = this.chart.label;
        var length = this._model[keyMain].peroids[currentPeriod].length;
        var periods = this._model[keyMain].peroids[currentPeriod];
        //console.log(currentPeriod+" "+that._model[keyMain].peroids[currentPeriod]+" "+periods);

            for(var i=0; i < length; i++){
                //console.log(that._model[keyMain].periods[i]+" "+that._model[keyMain].derived.interestRate()+" "+that._model[keyMain].investment);
                //console.log(this._model[keyMain].periods[currentPeriod][i]);
                var returnArray = compoundInterest(periods[i], this._model[keyMain].derived.interestRate(), this._model[keyMain].investment);
                var lastValue = returnArray[returnArray.length - 1];
                textOutput(i, lastValue);
    ...
    function writeOutput(id, msg, value){
        myCalculator.$outputs.values[id].innerHTML = msg+" "+value;
    }
    ...
    function onRangesliderChange(main, sub) {
        ...
        switch(value){
            case 1: label = 'year1'; break;
            case 2: label = 'year2'; break;
            case 3: label = 'year3'; break;
            case 4: label = 'year4'; break;
            case 5: label = 'year5'; break;
            default: label = 'year3'; break;
        }
        
        myCalculator.chart.label = label;
        myCalculator.chart[main].object.data.labels = myCalculator.chart.labels[label];
    ...
    myCalculator.chart.compoundInterest.object = setupLineChart(myCalculator.chart.tag);
})();